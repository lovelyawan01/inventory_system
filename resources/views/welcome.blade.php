...
<head>
  ...
  <link href="{{ asset('/admin/assets/img/264-2640361_inventory-management-system-png-transparent-png-removebg-preview.png')}}" rel="icon">
...
<body id="page-top">
 <div id="app">
  <div id="wrapper">
    <!-- Sidebar -->
    <nav id="sidebar" v-show="$route.path ===  '/' || $route.path ===  '/register' || $route.path ===  '/forget' || $route.path ===  '/index' ? false : true "  style="display: none;">
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="{{ asset('/admin/assets/img/264-2640361_inventory-management-system-png-transparent-png-removebg-preview.png')}}">
        </div>
     ...
     <li class="nav-item">
        ...
        <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="/salary" class="collapse-item" >Add Salary</router-link>
            <router-link to="/allsalaries" class="collapse-item">All Salaries</router-link>   
          </div>
        </div>
      </li>
     ...
     <li class="nav-item">
      ...
      <li class="nav-item">
         <router-link to="/stock" class="nav-link collapsed"  data-toggle="collapse" data-target="#collapseForm" aria-expanded="true"
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- TopBar -->
        <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" v-show="$route.path ===  '/' || $route.path ===  '/register' || $route.path ===  '/forget' || $route.path ===  '/index' ? false : true " style="display: none;">
